...
sceIoOpen		equ	0x088E5E24
sceIoLseek		equ	0x088E5E2C
sceIoRead		equ	0x088E5DF4
sceIoClose		equ	0x088E5E0C
sceKDWIA		equ	0x088E602C ; sceKernelDcacheWritebackInvalidateAll

SLOT_1			equ	0x09617270
SLOT_SIZE		equ	0x6800

SLTI_V0_S3		equ	0x09947578
SLTI_V0_S1		equ 0x099485FC

RETURN_VALID	equ	0x09948584
RETURN_INVALID	equ 0x0994857C

SP_EVENT_PAGE	equ 0x099B89C4
