...
sceIoOpen		equ	0x088E70B0
sceIoLseek		equ	0x088E70B8
sceIoRead		equ	0x088E7080
sceIoClose		equ	0x088E7098
sceKDWIA		equ	0x088E72B8 ; sceKernelDcacheWritebackInvalidateAll

SLOT_1			equ	0x09618570
SLOT_SIZE		equ	0x6800

SLTI_V0_S3		equ	0x09948828
SLTI_V0_S1		equ 0x099498AC

RETURN_VALID	equ	0x09949834
RETURN_INVALID	equ 0x0994982C

SP_EVENT_PAGE	equ 0x099B9CC4
